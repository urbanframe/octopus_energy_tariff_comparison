...
<img width="509" height="746" alt="image" src="https://github.com/user-attachments/assets/9d4cf443-1308-4fb9-9f82-ecb352caf741" />
...
```
### Check if current tariff is cheapest
```yaml
automation:
